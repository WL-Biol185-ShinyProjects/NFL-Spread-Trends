...
map_df$location[map_df$team_home == "Atlanta Falcons"] <- "GA"
map_df$location[map_df$team_home == "Buffalo Bills"] <- "NY"
map_df$location[map_df$team_home == "Cleveland Browns"] <- "OH"
map_df$location[map_df$team_home == "Dallas Cowboys"] <- "TX"
map_df$location[map_df$team_home == "Green Bay Packers"] <- "WI"
map_df$location[map_df$team_home == "Kansas City Chiefs"] <- "KC"
map_df$location[map_df$team_home == "Miami Dolphins"] <- "FL"
map_df$location[map_df$team_home == "Minnesota Vikings"] <- "MN"
map_df$location[map_df$team_home == "New England Patriots"] <- "MA"
map_df$location[map_df$team_home == "New Orleans Saints"] <- "LA"
map_df$location[map_df$team_home == "San Francisco 49ers"] <- "CA"
map_df$location[map_df$team_home == "Tennessee Titans"] <- "TN"
map_df$location[map_df$team_home == "Jacksonville Jaguars"] <- "FL"
map_df$location[map_df$team_home == "Philadelphia Eagles"] <- "PA"
map_df$location[map_df$team_home == "New York Jets"] <- "NY"
map_df$location[map_df$team_home == "Indianapolis Colts"] <- "IN"
map_df$location[map_df$team_home == "Seattle Seahawks"] <- "WA"
map_df$location[map_df$team_home == "Pittsburgh Steelers"] <- "PA"
map_df$location[map_df$team_home == "Washington Commanders"] <- "MD"
map_df$location[map_df$team_home == "Los Angeles Rams"] <- "CA"
map_df$location[map_df$team_home == "Arizona Cardinals"] <- "AZ"
map_df$location[map_df$team_home == "Baltimore Ravens"] <- "MD"
map_df$location[map_df$team_home == "Cincinnati Bengals"] <- "OH"
map_df$location[map_df$team_home == "Denver Broncos"] <- "CO"
map_df$location[map_df$team_home == "Detroit Lions"] <- "MI"
map_df$location[map_df$team_home == "Los Angeles Chargers"] <- "CA"
map_df$location[map_df$team_home == "Tampa Bay Buccaneers"] <- "FL"
map_df$location[map_df$team_home == "New York Giants"] <- "NY"
map_df$location[map_df$team_home == "Las Vegas Raiders"] <- "NV"
map_df$location[map_df$team_home == "Carolina Panthers"] <- "NC"
map_df$location[map_df$team_home == "Chicago Bears"] <- "IL"
map_df$location[map_df$team_home == "Houston Texans"] <- "TX"
...
```{r}
field = read.csv('NFLlocations.csv')
field
```

```{r}
field$Team[field$Team == "Titans"] <- "Tennessee Titans"
field$Team[field$Team == "Giants"] <- "New York Giants"
field$Team[field$Team == "Steelers"] <- "Pittsburgh Steelers"
field$Team[field$Team == "Panthers"] <- "Carolina Panthers"
field$Team[field$Team == "Ravens"] <- "Baltimore Ravens"
field$Team[field$Team == "Buccaneers"] <- "Tampa Bay Buccaneers"
field$Team[field$Team == "Colts"] <- "Indianapolis Colts"
field$Team[field$Team == "Vikings"] <- "Minnesota Vikings"
field$Team[field$Team == "Cardinals"] <- "Arizona Cardinals"
field$Team[field$Team == "Cowboys"] <- "Dallas Cowboys"
field$Team[field$Team == "Falcons"] <- "Atlanta Falcons"
field$Team[field$Team == "Jets"] <- "New York Jets"
field$Team[field$Team == "Broncos"] <- "Denver Broncos"
field$Team[field$Team == "Dolphins"] <- "Miami Dolphins"
field$Team[field$Team == "Eagles"] <- "Philadelphia Eagles"
field$Team[field$Team == "Bears"] <- "Chicago Bears"
field$Team[field$Team == "Patriots"] <- "New England Patriots"
field$Team[field$Team == "Redskins"] <- "Washington Commanders"
field$Team[field$Team == "Packers"] <- "Green Bay Packers"
field$Team[field$Team == "Chargers"] <- "Los Angeles Chargers"
field$Team[field$Team == "Saints"] <- "New Orleans Saints"
field$Team[field$Team == "Texans"] <- "Houston Texans"
field$Team[field$Team == "Bills"] <- "Buffalo Bills"
field$Team[field$Team == "Forty-Niners"] <- "San Francisco 49ers"
field$Team[field$Team == "Jaguars"] <- "Jacksonville Jaguars"
field$Team[field$Team == "Browns"] <- "Cleveland Browns"
field$Team[field$Team == "Raiders"] <- "Las Vegas Raiders"
field$Team[field$Team == "Chiefs"] <- "Kansas City Chiefs"
field$Team[field$Team == "Rams"] <- "Los Angeles Rams"
field$Team[field$Team == "Seahawks"] <- "Seattle Seahawks"
field$Team[field$Team == "Bengals"] <- "Cincinnati Bengals"
field$Team[field$Team == "Lions"] <- "Detroit Lions"
